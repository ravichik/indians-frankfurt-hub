          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 text-gray-400">
                ...
                <span className="text-sm">Frankfurt am Main, Germany</span>
              </li>
              <li className="flex items-center space-x-3 text-gray-400">
                <FiMail className="w-4 h-4 flex-shrink-0" />
                <span className="text-sm">info@indiansinfrankfurt.de</span>
              </li>
              <li className="flex items-center space-x-3 text-gray-400">
                <FiPhone className="w-4 h-4 flex-shrink-0" />
                <span className="text-sm">+49 69 1234 5678</span>
              </li>
            </ul>
          </div>
        </div>
